...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div >
       <h2 class="style27"> Fortified Chain A Blockchain Based Framework for Security and Privacy Assured Internet of Medical Things With Effective Access Control</h2>
      </div>
      <div class="menu_nav">
        <ul>
	...
	while ( rs.next() )
	   {
		...
		%>
                          <tr>
                            ...
                            <td><div align="center">
                              <form action="PS_report.jsp" method="get">
