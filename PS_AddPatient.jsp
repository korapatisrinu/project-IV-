...
<div class="main">
  ...
  <div class="content">
	...
	if(rs.next())
	{
			...
			{ 
				%>
				<form action="PS_AddPatient0.jsp" method="post" id="" >
				<label for="name"><br />
				</label>
				...
				<td width="334"><label><%ResultSet r=connection.createStatement().executeQuery("select distinct(hospital) from doctor");
				ArrayList hos=new ArrayList();
				while (r.next())
				{
					String hospital=r.getString(1);
					hos.add(hospital);
				}
				%>
			...
			else
			{
				...
				<span class="style20">You Dont Have Encryption Public Key </span> !!</h3>
				        <br />
				<form action="PS_EncryptRequest.jsp" method="get"><input name="" type="submit"  value="Request For Encryption Key"/></form>
				<br/>
				<br/>
				<br/>
				<br/>
