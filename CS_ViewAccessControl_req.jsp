	...
	while( rs.next() )
	   {
		...
		%>
			...
			{
				%>
                  <td width="125" height="28"><div align="center"><a href="CS_Provide_Access_DocPer.jsp?id=<%=i%>">Provide Permission</a></div></td>
                  <%
			}
			else
			{
		...
		if(s6.equalsIgnoreCase("Requested"))
			{
				%>
                  <td width="64" height="28"><div align="center"><a href="CS_Provide_Access_DetailsPer.jsp?id=<%=i%>">Provide Permission</a></div></td>
                  <%
			}
			else
			{
