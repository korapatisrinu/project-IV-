  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2><span>Authorize Patient Sensor</span></h2>
            <p class="infopost">&nbsp;</p>
            <div class="clr"></div>
            <div >
              <p align="justify">&nbsp;</p>
	...
	while ( rs.next() )
	   {
		...
		%>
                ...
                <tr>
                  ...
                  <td><div align="center"><a href="CS_ProviderDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
                  <%	
		...
		%>
                  <td><div>
                      <div align="center"><a href="CS_StatusProvider.jsp?id=<%=i%>"><%=s5%></a></div>
                  </div></td>
                  <%
