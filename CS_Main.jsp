...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div >
        <h1><a href="index.html" class="style2 style20">Fortified Chain A Blockchain Based Framework for Security and Privacy Assured Internet of Medical Thingsl With Effective Access Control</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
      ...
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            ...
            <p class="infopost">&nbsp;</p>
            <div class="clr"></div>
            <div class="img"><img src="images/img1.jpg" width="179" height="437" alt="" class="fl" /></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="CS_DocAutho.jsp">&raquo; View and Authorize Doctor </a></li>
            <li><a href="CS_ProviderAutho.jsp">&raquo; View and Authorize Patient Sensor </a></li>
            <li><a href="CS_Clinical_Reports.jsp">&raquo; View Clinical Report </a></li>
            <li><a href="CS_ViewDetails.jsp">&raquo; View Patient Details</a></li>
			<li><a href="CS_Patients_By_Blockchain.jsp">&raquo; Trace Patients By Blockchain</a></li>
            <li><a href="CS_ViewAccessControl_req.jsp">&raquo; View Access Control Req </a></li>
			
            <li><a href="HK_En_Key_Requests.jsp">&raquo; View Encryption Key Requests </a></li>
            <li><a href="CS_Key_Transactions.jsp">&raquo; View Key Transactions</a></li>
            <li><a href="CS_Chart.jsp">&raquo; View Result in Chart </a></li>
