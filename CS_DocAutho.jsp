            ...
            <div >
              ...
              <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
                <tr>
                  ...
                  <td width="183" bgcolor="#FF0000"><div align="center" class="style25"> Doctor Name </div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
                ...
                <tr>
                  ...
                  <td><div align="center"><a href="CS_OwnerDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
                  <%	
		...
		%>
                  <td><div>
                      <div align="center"><a href="CS_StatusOwner.jsp?id=<%=i%>"><%=s5%></a></div>
                  </div></td>
                  <%
