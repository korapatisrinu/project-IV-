      ...
      <div class="mainbar">
        <div class="article">
		  ...
		  if(hospital.equalsIgnoreCase("-Select-"))
		  {
            ...
            <a href="PS_AddPatient.jsp">Back</a>
            <%
		  ...
		  %> 
            ...
            <form action="PS_AddPatient1.jsp" method="post" id="" enctype="multipart/form-data">
              <label for="name"><br />
			 <input type="hidden" name="keys" value="<%=keys%>" />
              </label>
              <table width="590" height="851" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="259" height="35" bgcolor="#000000" scope="row"><div align="left" class="style22 style28">Patient Name  : </div></td>
                  <td width="343"><input id="name" name="p_name" class="text" /></td>
                </tr>
                <tr>
                  <td height="35" bgcolor="#000000" ><div align="left" class="style29">Blood Group   : </div></td>
                  <td><input  id="bloodgroup" name="bloodgroup" class="text" /></td>
                </tr>
                <tr>
                  <td height="35" bgcolor="#000000" scope="row"><div align="left" class="style29"> Hospital  : </div></td>
                  <td>
                    <input readonly="readonly" id="hospital" name="hospital" value="<%=hospital%>">                 </td>
                </tr>
                <tr>
                  <td height="35" bgcolor="#000000" scope="row"><div align="left" class="style29">Select Doctor  : </div></td>
                  <td><label>
                ...
                <tr>
                  <td height="35" bgcolor="#000000" scope="row"><div align="left" class="style29">Disease : </div></td>
                  <td><input id="disease" name="disease" class="text" /></td>
                </tr>
                <tr>
                  <td height="35" bgcolor="#000000" scope="row"><div align="left" class="style29">Age : </div></td>
                  <td><input id="age" name="age" class="text" /></td>
                </tr>
                <tr>
                  <td height="35" bgcolor="#000000" scope="row"><span class="style28"><span class="style27"><span class="style24">
                    <label for="label"> </label>
                      <label for="label">
                      </span>
                    </span></span><div align="left" class="style29">Patient Address : </div>
                    <span class="style29">
                    </label>
                  </span></td>
                ...
                <tr>
                  <td height="35" bgcolor="#000000" scope="row"><span class="style28"><span class="style27"><span class="style24">
                    ...
                    </span></span><div align="left" class="style29">Date of Birth  : </div>
                    <span class="style29">
                    </label>
                  </span></td>
                ...
                <tr>
                  <td height="35" bgcolor="#000000" scope="row"><div align="left" class="style29"> Gender : </div></td>
                ...
                <tr>
                  <td height="35" bgcolor="#000000" scope="row"><span class="style28"><span class="style27"><span class="style24">
                    ...
                    </span></span><div align="left" class="style29">E-mail : </div>
                    <span class="style29">
                    </label>
                  </span></td>
                ...
                <tr>
                  <td height="35" bgcolor="#000000" scope="row"><span class="style28"><span class="style27"><span class="style24">
                    ...
                    </span></span><div align="left" class="style29">Mobile : </div>
                    <span class="style29">
                    </label>
                  </span></td>
                ...
                <tr>
                  <td height="35" bgcolor="#000000"><span class="style29">Select File(Patient Description) :-</span></td>
                  <td><input required="required" type="file" name="p_desc_fn" id="file"  onchange="loadFileAsText()" /></td>
                </tr>
                <tr>
                  <td height="264" bgcolor="#000000"><span class="style29">Patient Description : </span></td>
              ...
              <p align="right"><a href="PS_Main.jsp">Back</a></p>
            </form><%}%>
          </div>
          <div class="clr"></div>
        </div>
